...
<form action="/habitats/editHabitat/<?= $habitat['id'] ?>" method="post" enctype="multipart/form-data">
    ...
    <textarea class="w-100" name="description" id="description" required><?= htmlspecialchars($habitat['description']) ?></textarea><br>

    <label for="description_courte">Description courte :</label>
    <textarea class="w-100" name="description_courte" id="description_courte" required><?= htmlspecialchars($habitat['description_courte']) ?></textarea><br>
