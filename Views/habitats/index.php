                    ...
                    <div class="carousel-item <?= $index === 0 ? 'active' : '' ?>">
                        <div class="d-flex justify-content-center align-items-center">
                            <img src="/assets/images/<?= htmlspecialchars($habitat['image']) ?>"
                                 ...
                                 alt="<?= htmlspecialchars($habitat['name']) ?>" loading="lazy">
                        </div>
                    </div>
                <?php endforeach; ?>
            <?php endif; ?>
...
<!-- Liste des habitats avec disposition alternée -->
<div class="space"></div>
                ...
                <?php if ($index % 2 == 0): ?>
                    ...
                    <div class="col-lg-6 d-flex justify-content-center order-image-first">
                        <img src="/assets/images/<?= htmlspecialchars($habitat['image2']) ?>"
                             class="img-fluid p-2" alt="<?= htmlspecialchars($habitat['name']) ?>" loading="lazy">
                    </div>
                    <div class="col-lg-6 colorSection2 p-4 d-flex flex-column justify-content-center align-items-center order-text-second">
                        ...
                        <a href="/habitats/showHabitat/<?= $habitat['id']; ?>" class="btn btn-primary w-50 py-4">
